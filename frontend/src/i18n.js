...
const translations = {
  en: {
    ...
    "inv.cat.dairyEggs": "Dairy & Eggs",
    "inv.cat.fruitsVegetables": "Fruits & Vegetables",
    "inv.cat.bakery": "Bakery",
    "inv.cat.meatPoultry": "Meat & Poultry",
    "inv.cat.pantry": "Pantry",
    "inv.cat.beverages": "Beverages",
    "inv.cat.frozen": "Frozen",
    "inv.cat.household": "Household",
    ...
    "rec.searchPlaceholder": "Search recipes",
    "rec.search": "Search",
    "rec.steps": "Steps",
    ...
    "rec.videoLink": "Video link",
    "rec.videoLinkPlaceholder": "Paste a YouTube link",
    "rec.videoLinkSaved": "Video link saved",
    "rec.watchVideo": "Watch video",
    "rec.suggestTitle": "Suggest a recipe",
    "rec.suggestPlaceholder": "Recipe name (e.g. Tajine)",
    "rec.suggestLookup": "Look up",
    "rec.suggestImport": "Import",
    "rec.suggestEmpty": "No matches found — try a different name, or the recipe index may be due for a refresh.",
    "rec.suggestImported": "Imported \"{{title}}\"",
    "rec.searchYoutube": "Search YouTube",
    "rec.useVideo": "Use this video",
    "rec.ytEmpty": "No videos found — try a different search.",
    ...
    "pr.noHistory": "No price history yet.",
    "pr.showAsTable": "Show as table",
    "pr.showAsChart": "Show as chart",
    "pr.tableDate": "Date",
    "pr.tablePrice": "Price (MAD)",
    "pr.asOf": "as of {{time}}",
    "pr.today": "today",
    ...
    "auth.iAmAdmin": "I'm the admin",
    "auth.iAmFamilyMember": "I'm a family member",
    "auth.pinRequired": "PIN (required, 4-6 digits)",
  ...
  fr: {
    ...
    "inv.cat.dairyEggs": "Produits laitiers & œufs",
    "inv.cat.fruitsVegetables": "Fruits & légumes",
    "inv.cat.bakery": "Boulangerie",
    "inv.cat.meatPoultry": "Viande & volaille",
    "inv.cat.pantry": "Garde-manger",
    "inv.cat.beverages": "Boissons",
    "inv.cat.frozen": "Surgelés",
    "inv.cat.household": "Entretien",
    ...
    "rec.searchPlaceholder": "Rechercher des recettes",
    "rec.search": "Rechercher",
    "rec.steps": "Étapes",
    ...
    "rec.videoLink": "Lien vidéo",
    "rec.videoLinkPlaceholder": "Collez un lien YouTube",
    "rec.videoLinkSaved": "Lien vidéo enregistré",
    "rec.watchVideo": "Regarder la vidéo",
    "rec.suggestTitle": "Suggérer une recette",
    "rec.suggestPlaceholder": "Nom de la recette (ex. Tajine)",
    "rec.suggestLookup": "Rechercher",
    "rec.suggestImport": "Importer",
    "rec.suggestEmpty": "Aucun résultat — essayez un autre nom, ou l'index des recettes doit peut-être être actualisé.",
    "rec.suggestImported": "\"{{title}}\" importée",
    "rec.searchYoutube": "Rechercher sur YouTube",
    "rec.useVideo": "Utiliser cette vidéo",
    "rec.ytEmpty": "Aucune vidéo trouvée — essayez une autre recherche.",
    ...
    "pr.noHistory": "Aucun historique de prix pour l'instant.",
    "pr.showAsTable": "Afficher en tableau",
    "pr.showAsChart": "Afficher en graphique",
    "pr.tableDate": "Date",
    "pr.tablePrice": "Prix (MAD)",
    "pr.asOf": "au {{time}}",
    ...
    "auth.iAmAdmin": "Je suis l'administrateur",
    "auth.iAmFamilyMember": "Je suis un membre de la famille",
    "auth.pinRequired": "Code PIN (obligatoire, 4-6 chiffres)",
